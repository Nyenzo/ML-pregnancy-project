...
# In DHS datasets, highest_education_level is typically coded as:
...
# Descriptive Statistics for highest_education_level
# Frequency table for highest_education_level
print("Frequency table for highest_education_level:")
print(table(df$highest_education_level))
print("Proportions for highest_education_level:")
print(prop.table(table(df$highest_education_level)))

# Cross-tabulation of highest_education_level by apo_general
print("Cross-tabulation of highest_education_level by apo_general:")
print(table(df$highest_education_level, df$apo_general))
print("Proportions of highest_education_level by apo_general:")
print(prop.table(table(df$highest_education_level, df$apo_general), margin = 1))

# Visualization: Bar plot of highest_education_level by apo_general
ggplot(df, aes(x = highest_education_level, fill = apo_general)) +
  geom_bar(position = "fill") +
  labs(title = "Highest Education Level by Pregnancy Outcome", 
       x = "Highest Education Level", y = "Proportion") +
  theme_minimal()